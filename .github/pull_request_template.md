...
- [ ] 💄 Cambio de UI/UX (mejoras visuales o de experiencia)
- [ ] ♻️ Refactorización (cambio que no corrige bug ni añade feature)
...
<!-- Enlaza los issues que este PR cierra o referencia -->
...
- [ ] No hay issues de seguridad obvios
