...
export const experienceTimeline: ExperienceItem[] = [
  ...
  {
    id: 'fastbyte',
    role: 'Desarrollador Full-Stack & Tech Lead',
    company: 'Fastbyte SL',
    location: 'Barcelona, España',
    period: {
      start: '2019-01',
    ...
    type: 'consultant',
    description:
      'Mantenimiento y evolución de un ERP en producción para servicios técnicos, y diseño e implementación de su migración full-stack a Symfony/API Platform + Next.js. Trabajo hands-on en backend y frontend, con foco en arquitectura, calidad y entregas por fases.',
    responsibilities: [
      'Mantenimiento y modernización incremental del ERP legacy en PHP',
      'Diseño de la API REST con API Platform (patrón State Provider/Processor)',
      'Desarrollo del frontend SPA en Next.js / React / TypeScript',
      'Definición de arquitectura y decisiones técnicas (ADRs)',
      'Testing automatizado en backend y frontend',
    ],
    achievements: [
      'API con 16 entidades y ~34 endpoints documentados (OpenAPI / JSON-LD)',
      'SPA con 300+ tests y validación schema-first (Zod)',
      'Modernización incremental del legacy (Repository pattern, DI, Twilio/WhatsApp, DomPDF)',
    ],
    technologies: [
      'Symfony',
      'API Platform',
    ...
    highlights: ['Migración full-stack', 'Arquitectura API', 'Modernización legacy'],
  },
