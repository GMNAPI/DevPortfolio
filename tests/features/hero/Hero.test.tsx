...
describe('Hero Section', () => {
  describe('Rendering', () => {
    it('should render main heading "Desarrollo cosas"', () => {
      render(<Hero />);
      expect(screen.getByRole('heading', { name: /desarrollo cosas/i })).toBeInTheDocument();
    });
    ...
    it('should have proper heading hierarchy', () => {
      render(<Hero />);
      const heading = screen.getByRole('heading', { name: /desarrollo cosas/i });
